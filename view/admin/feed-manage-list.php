...
class WpWoof_Feed_Manage_list extends Wpwoof_Feed_List_Table {
    ...
    function column_default($item, $column_name) {
        ...
        switch ($column_name) {
            ...
            case 'feedaction':
                $upload_dir = wpwoof_feed_dir($itemInfo['feed_name']);
                $view = isset($upload_dir['url']) ? $upload_dir['url'] : '';
            ...
            case 'feeddownload':
                ...
                if ($itemInfo['feed_type']!="googleReviews" )$return .= '<a disabled="disabled" id="wpwoof_status_'.$option_id.'c" class="wpwoof-button-forlist gray" href="'.$download_csv.'" target="_blank">CSV</a>';
