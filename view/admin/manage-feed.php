        ...
        <table class="form-table manage_global_settings_block">
            <tr>
                ...
                <td>
                    ...
                    <select name="wpwoof_schedule" id="wpwoof_schedule" onchange="jQuery.fn.saveWPWoofParam({'action':'set_wpwoof_shedule'});">
                        <?php 
            ...
            <tr>
                ...
                <td>
                    <input type="time" name="wpwoof_schedule_from" value="<?=get_option('wpwoof_schedule_from',"")?>"
                        onchange="jQuery.fn.saveWPWoofParam({'action':'set_wpwoof_shedule'});"> 
                </td>
            </tr>
            <tr>
