...
?>
    ...
    <?php    if(WoocommerceWpwoofCommon::isActivatedWMPL() && isset($woocommerce_wpml) && is_object($woocommerce_wpml) && isset($woocommerce_wpml->settings['enable_multi_currency']) 
